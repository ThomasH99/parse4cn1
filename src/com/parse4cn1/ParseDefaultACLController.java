...
//      ParseUser currentUser = ParseUser.getCurrentUser(); //THJ
...
//          lastCurrentUser = new WeakReference<ParseUser>(currentUser); //THJ
          lastCurrentUser = new WeakReference(currentUser); //THJ
