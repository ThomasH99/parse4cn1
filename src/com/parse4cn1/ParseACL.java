...
//    
//      public ParseDefaultACLController getDefaultACLController() { //THJ, copied from ParseCorePlugins.java
...
//    private ParseUser unresolvedUser; //THJ
...
//        copy.unresolvedUser = unresolvedUser; //THJ
//    if (unresolvedUser != null) { //THJ
...
//    /* package */ JSONObject toJSONObject(ParseEncoder objectEncoder) { //THJ - not used
//        JSONObject json = new JSONObject();
//        try {
//            for (String id : permissionsById.keySet()) {
...
//        return json;
//    }
//    /* package */ JSONObject encode(ParseEncoder objectEncoder) { //THJ - not used
    /* package */ public JSONObject encode(IParseObjectEncodingStrategy objectEncoder) throws ParseException { //THJ - not used
        JSONObject json = new JSONObject();
        try {
            for (String id : permissionsById.keySet()) {
//                json.put(id, permissionsById.get(id).toJSONObject());
                json.put(id, permissionsById.get(id).encode());
            }
//            if (unresolvedUser != null) {  //THJ
//                Object encoded = objectEncoder.encode(unresolvedUser);
//                json.put(UNRESOLVED_USER_JSON_KEY, encoded);
...
//            throw new JSONException(e);
            throw new ParseException(ParseException.INVALID_JSON, ParseException.ERR_PREPARING_REQUEST, e); //THJ
        }
        return json;
    }
...
//    /* package */ static ParseACL createACLFromJSONObject(JSONObject object, ParseDecoder decoder) { //THJ, not used
...
//    /* package for tests */ void resolveUser(ParseUser user) {  //THJ
...
//  private static class UserResolutionListener implements GetCallback<ParseObject> { //THJ
