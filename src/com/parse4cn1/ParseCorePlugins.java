...
//  private AtomicReference<ParseDefaultACLController> defaultACLController = new AtomicReference<>(); //THJ
  private ParseDefaultACLController defaultACLController = new ParseDefaultACLController(); //THJ - removed AtomicReference, not supported by CN1
...
//    defaultACLController.set(null);
    defaultACLController = null; //THJ - remove AtomicReference set()
...
//      defaultACLController.compareAndSet(null, controller);
      if (defaultACLController==null) defaultACLController= controller;
    }
//    return defaultACLController.get();
    return defaultACLController;
  }
...
//    if (!defaultACLController.compareAndSet(null, controller)) {
    if (defaultACLController==null) defaultACLController= controller; //THJ
    else {//THJ
      throw new IllegalStateException(
//          "Another defaultACL controller was already registered: " + defaultACLController.get());
          "Another defaultACL controller was already registered: " + defaultACLController);
    }
  }
